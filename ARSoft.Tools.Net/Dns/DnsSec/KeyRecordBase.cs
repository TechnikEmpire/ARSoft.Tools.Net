...
namespace ARSoft.Tools.Net.Dns
{
    ...
    public abstract class KeyRecordBase : DnsRecordBase
    {
        ...
        public enum KeyTypeFlag : ushort
        {
            ...
            /// </para>
            /// <para>
            /// Defined in <see cref="!:http://tools.ietf.org/html/rfc2535"> RFC 2535 </see>
            /// </para>
            /// </summary>
        ...
        public KeyTypeFlag Type
        {
            get
            {
                return (KeyTypeFlag)(Flags & 0xc000);
            }
            set
            {
        ...
        public NameTypeFlag NameType
        {
            get
            {
                return (NameTypeFlag)(Flags & 0x0300);
            }
            set
            {
        ...
        protected abstract int MaximumPublicKeyLength
        {
            get;
        }
