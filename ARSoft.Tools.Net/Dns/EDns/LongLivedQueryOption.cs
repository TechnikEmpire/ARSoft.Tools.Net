...
namespace ARSoft.Tools.Net.Dns
{
    ...
    /// </para>
    /// <para>
    /// Defined in <see cref="!:http://files.dns-sd.org/draft-sekar-dns-llq.txt"> draft-sekar-dns-llq </see>
    /// </para>
    /// </summary>
    public class LongLivedQueryOption : EDnsOptionBase
    {
        ...
        public enum LlqErrorCode : ushort
        {
            ...
            /// <summary>
            /// The server cannot grant the LLQ request because it is overloaded, or the request
            /// exceeds the server's rate limit.
            /// </summary>
            ServerFull = 1,

            /// <summary>
            /// The data for this name and type is not expected to change frequently, and the server
            /// therefore does not support the requested LLQ.
            /// </summary>
            Static = 2,
        ...
        /// </summary>
        public LlqOperationCode OperationCode
        {
            get; private set;
        }
