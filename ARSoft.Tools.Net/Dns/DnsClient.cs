...
namespace ARSoft.Tools.Net.Dns
{
    ...
    {
        /// <summary>
        /// Returns a default instance of the DnsClient, which uses the configured dns servers of the
        /// executing computer and a query timeout of 10 seconds.
        /// </summary>
        ...
        public new bool IsUdpEnabled
        {
            get
            {
                return base.IsUdpEnabled;
            }
            set
            {
                base.IsUdpEnabled = value;
            }
        }
        ...
        public new bool IsTcpEnabled
        {
            get
            {
                return base.IsTcpEnabled;
            }
            set
            {
                base.IsTcpEnabled = value;
            }
        }
        ...
        public static List<IPAddress> GetLocalConfiguredDnsServers()
        {
            ...
            try
            {
                foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
                {
                    if ((nic.OperationalStatus == OperationalStatus.Up) && (nic.NetworkInterfaceType != NetworkInterfaceType.Loopback))
                    {
                        ...
                        {
                            // only use servers defined in draft-ietf-ipngwg-dns-discovery if they
                            // are in the same subnet fec0::/10 is marked deprecated in RFC 3879, so
                            // nobody should use these addresses
            ...
            // try parsing resolv.conf since getting data by NetworkInterface is not supported on
            // non-windows mono
