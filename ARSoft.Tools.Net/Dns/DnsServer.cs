...
namespace ARSoft.Tools.Net.Dns
{
    ...
    {
        /// <summary>
        /// Represents the method, that will be called to get the keydata for processing a tsig
        /// signed message
        /// </summary>
        ...
        /// The address, on which should be listend
        /// </param>
        /// <param name="udpListenerCount">
        /// The count of threads listings on udp, 0 to deactivate udp
        /// </param>
            ...
            try
            {
                ...
                using (NetworkStream stream = client.GetStream())
                {
                    while (true)
                    {
                        ...
                        // Since support for multiple tsig signed messages is not finished, just
                        // close connection after response to first signed query
                        if (newTsigMac != null)
                            break;
                    }
                }
