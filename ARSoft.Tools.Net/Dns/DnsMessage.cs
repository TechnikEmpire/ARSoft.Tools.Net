...
namespace ARSoft.Tools.Net.Dns
{
    ...
    public class DnsMessage : DnsMessageBase
    {
        ...
        /// </para>
        /// <para>
        /// Defined in <see cref="!:http://tools.ietf.org/html/rfc4035"> RFC 4035 </see>
        /// </para>
        /// </summary>
        ...
        public new List<DnsQuestion> Questions
        {
            ...
            set
            {
                base.Questions = (value ?? new List<DnsQuestion>());
            }
        }
        ...
        public new List<DnsRecordBase> AnswerRecords
        {
            get
            {
                return base.AnswerRecords;
            }
            set
            {
                base.AnswerRecords = (value ?? new List<DnsRecordBase>());
            }
        }
        ...
        public new List<DnsRecordBase> AuthorityRecords
        {
            get
            {
                return base.AuthorityRecords;
            }
            set
            {
                base.AuthorityRecords = (value ?? new List<DnsRecordBase>());
            }
        }
        ...
        /// </para>
        /// <para>
        /// Defined in <see cref="!:http://tools.ietf.org/html/rfc4035"> RFC 4035 </see> and
