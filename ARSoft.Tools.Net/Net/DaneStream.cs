...
{
    /// <summary>
    /// Provides a stream used for client-server communication that uses SSL/TLS and DANE/TLSA
    /// validation to authenticate the server.
    /// </summary>
    public class DaneStream : AuthenticatedStream
    {
        ...
        /// </param>
        /// <param name="enforceTlsaValidation">
        ...
        /// A callback to select client certificates to authenticate the client to the server
        /// </param>
        ...
        /// </param>
        /// <param name="offset">
        /// A Int32 that contains the zero-based location in buffer at which to begin storing the
        ...
        /// </param>
        /// <returns>
        /// A Int32 value that specifies the number of bytes read. When there is no more data to be
        /// read, returns 0.
        /// </returns>
        ...
        /// </param>
        /// <param name="offset">
        /// A Int32 that contains the zero-based location in buffer at which to begin reading bytes
        ...
        /// </param>
        /// <param name="asyncCallback">
        /// An AsyncCallback delegate that references the method to invoke when the write operation
        /// is complete.
        /// </param>
        /// <param name="asyncState">
        ...
        /// </summary>
        public bool IsAuthenticatedByDane
        {
            get; private set;
        }
        ...
        /// <summary>
        /// Gets a Boolean value that indicates whether the local side of the connection used by this
        /// SslStream was authenticated as the server.
        /// </summary>
        ...
        /// <summary>
        /// Gets a Boolean value that indicates whether the certificate revocation list is checked
        ...
        public override int ReadTimeout
        {
            get
            {
                return _sslStream.ReadTimeout;
            }
            set
            {
                _sslStream.ReadTimeout = value;
            }
        }
        ...
        public override int WriteTimeout
        {
            get
            {
                return _sslStream.WriteTimeout;
            }
            set
            {
                _sslStream.WriteTimeout = value;
            }
        }
        ...
        public override long Position
        {
            get
            {
                return _sslStream.Position;
            }
            set
            {
                _sslStream.Position = value;
            }
        }
