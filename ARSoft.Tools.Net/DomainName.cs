...
namespace ARSoft.Tools.Net
{
    ...
    public class DomainName : IEquatable<DomainName>, IComparable<DomainName>
    {
        ...
        /// </param>
        /// <param name="name">
        /// When this method returns, contains a DomainName instance representing s or null, if s
        /// could not be parsed
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Compares the current instance with another name and returns an integer that indicates
        /// whether the current instance precedes, follows, or occurs in the same position in the
        /// sort order as the other name.
        /// </summary>
        /// <param name="other">
